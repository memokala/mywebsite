    ...
    <JsonLd
      data={{
        ...
        potentialAction: {
          ...
          target: {
            "@type": "EntryPoint",
            urlTemplate: "https://worldpdf.com/search?q={search_term_string}",
          },
  ...
  return (
    <JsonLd
      data={{
        ...
        name: "WorldPDF",
        url: "https://worldpdf.com",
        logo: "https://worldpdf.com/icons/apple-icon.png",
        sameAs: [
...
export function ToolPageSchema({
  ...
  const baseUrl = "https://worldpdf.com";
