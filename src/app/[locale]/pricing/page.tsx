...
export async function generateMetadata({ params }: Props) {
  ...
  const title = isAr ? "باقات الأسعار — WorldPDF" : "Pricing - WorldPDF";
  const description = isAr
    ? "خطط أسعار بسيطة وشفافة لأدوات WorldPDF. استخدم الأدوات مجاناً 100% أو اختر الباقة الاحترافية للميزات المتقدمة."
    : "Choose the perfect plan for your needs. Free, Pro, and Business plans available.";

  return {
    title,
    description,
    alternates: {
      canonical: `https://www.myworldpdf.com/${locale}/pricing`,
      languages: {
        en: "https://www.myworldpdf.com/en/pricing",
        ar: "https://www.myworldpdf.com/ar/pricing",
        "x-default": "https://www.myworldpdf.com/en/pricing",
      },
    },
    openGraph: {
      title,
      description,
      url: `https://www.myworldpdf.com/${locale}/pricing`,
      siteName: "WorldPDF",
      type: "website",
    },
  };
...
export default async function PricingPage({ params }: Props) {
  ...
  const targetUrl = isLoggedIn ? `/${locale}/account/billing` : `/${locale}/register`;
