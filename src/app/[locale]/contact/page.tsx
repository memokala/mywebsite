...
export async function generateMetadata() {
  return {
    title: "Contact Us - WorldPDF",
    description: "Get in touch with the WorldPDF team. We'd love to hear from you.",
  };
}
...
export default async function ContactPage({ params }: Props) {
  ...
  const contactMethods = [
    { icon: Mail, title: "Email Us", description: "support@worldpdf.com", detail: "We respond within 24 hours" },
