...
export async function generateMetadata() {
  return {
    title: "Privacy Policy - WorldPDF",
    description: "WorldPDF Privacy Policy. Learn how we protect your data and privacy.",
  };
}
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose-nova space-y-8">
          <section>
            ...
            <p>
              WorldPDF (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website worldpdf.com.
            </p>
          </section>
          ...
          <section>
            <h2>9. Contact Us</h2>
            <p>
              If you have questions about this Privacy Policy, please contact us at support@worldpdf.com.
            </p>
          </section>
        </div>
      </div>
