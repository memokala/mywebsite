...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://worldpdf.com/${locale}/how-it-works`,
      languages: {
        en: "https://worldpdf.com/en/how-it-works",
        ar: "https://worldpdf.com/ar/how-it-works",
        "x-default": "https://worldpdf.com/en/how-it-works",
      },
    },
  };
}
