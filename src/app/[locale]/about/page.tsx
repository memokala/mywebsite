...
export async function generateMetadata() {
  return {
    title: "About Us - WorldPDF",
    description: "Learn about WorldPDF, the most advanced online tools platform. Our mission is to provide free, fast, and secure tools for everyone.",
  };
}
