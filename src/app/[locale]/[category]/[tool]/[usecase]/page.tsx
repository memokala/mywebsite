...
import { ToolTool } from "@/components/tools/tool-tool";
...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://worldpdf.com/${locale}/${category}/${tool}/${locale === "ar" ? arSlug : enSlug}`,
      languages: {
        "en": `https://worldpdf.com/en/${category}/${tool}/${enSlug}`,
        "ar": `https://worldpdf.com/ar/${category}/${tool}/${arSlug}`,
        "x-default": `https://worldpdf.com/en/${category}/${tool}/${enSlug}`,
      },
    },
    openGraph: {
      title: ucData.metaTitle,
      description: ucData.metaDescription,
      url: `https://worldpdf.com/${locale}/${category}/${tool}/${locale === "ar" ? arSlug : enSlug}`,
      type: "website",
      siteName: "WorldPDF",
    },
    twitter: {
