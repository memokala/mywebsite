...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    description: seoDesc,
    alternates: {
      canonical: `https://worldpdf.com/${locale}/${category}/${t.slug}`,
      languages: {
        "en": `https://worldpdf.com/en/${category}/${t.slug}`,
        "ar": `https://worldpdf.com/ar/${category}/${t.slug}`,
        "x-default": `https://worldpdf.com/en/${category}/${t.slug}`,
      },
    },
    openGraph: {
      title: seoTitle,
      description: seoDesc,
      url: `https://worldpdf.com/${locale}/${category}/${t.slug}`,
      type: "website",
      siteName: "WorldPDF",
    },
    twitter: {
