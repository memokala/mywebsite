...
export async function generateMetadata() {
  return {
    title: "Cookie Policy - WorldPDF",
    description: "WorldPDF Cookie Policy. Learn about how we use cookies.",
  };
}
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose-nova space-y-8">
          ...
          <section>
            <h2>Contact Us</h2>
            <p>
              If you have any questions about our Cookie Policy, please contact us at support@worldpdf.com.
            </p>
          </section>
        </div>
      </div>
