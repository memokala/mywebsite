...
export async function generateMetadata({ params }: Props) {
  ...
  const title = isAr ? "شروط الخدمة — WorldPDF" : "Terms of Service - WorldPDF";
  const description = isAr
    ? "شروط أحكام استخدام خدمات وأدوات WorldPDF للتعامل مع ملفات المستندات أونلاين."
    : "WorldPDF Terms of Service. Read our terms and conditions.";

  return {
    title,
    description,
    alternates: {
      canonical: `https://www.myworldpdf.com/${locale}/terms`,
      languages: {
        en: "https://www.myworldpdf.com/en/terms",
        ar: "https://www.myworldpdf.com/ar/terms",
        "x-default": "https://www.myworldpdf.com/en/terms",
      },
    },
    openGraph: {
      title,
      description,
      url: `https://www.myworldpdf.com/${locale}/terms`,
      siteName: "WorldPDF",
      type: "website",
    },
  };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose-nova space-y-8">
          ...
          <section>
            <h2>8. Contact</h2>
            <p>
              If you have any questions about these Terms, please contact us at support@myworldpdf.com.
            </p>
          </section>
        </div>
      </div>
